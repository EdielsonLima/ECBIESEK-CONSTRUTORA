          ...
          <table className="w-full divide-y divide-gray-200 table-fixed text-[11px]">
            ...
            <thead className="bg-blue-50 sticky top-[85px] z-30 shadow-[0_2px_4px_rgba(0,0,0,0.1)]">
              <tr>
                ...
                <th onClick={() => toggleOrdenacao('codigo_centrocusto')} className="py-2 text-center text-[10px] font-medium uppercase text-gray-500 cursor-pointer hover:bg-blue-100" style={{width:'28px',maxWidth:'28px',padding:'0 1px'}}>
                  CC
                </th>
                ...
                return (
                  <React.Fragment key={index}>
                    <tr className={`${isExpanded ? 'bg-blue-100 border-l-4 border-l-blue-600' : isNovoAposRef ? 'bg-yellow-50 hover:bg-yellow-100' : 'hover:bg-gray-50'} cursor-pointer transition-colors duration-150`} onClick={handleExpand}>
                      ...
                      <td className="whitespace-nowrap py-2 text-center text-gray-400 font-mono text-[10px]" style={{width:'28px',maxWidth:'28px',padding:'0 1px'}}>{(conta as any).codigo_centrocusto || '-'}</td>
