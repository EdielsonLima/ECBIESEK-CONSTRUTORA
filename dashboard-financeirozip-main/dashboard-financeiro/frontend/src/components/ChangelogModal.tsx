...
export const ChangelogModal: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="overflow-hidden rounded-2xl bg-white dark:bg-slate-800 shadow-2xl">
          {/* Header */}
          <div className="relative bg-gradient-to-r from-blue-700 to-indigo-600 px-6 py-6 text-white">
            <div className="absolute right-4 top-4">
              <button
                type="button"
                onClick={fechar}
                className="rounded-full p-1 text-white/70 transition-colors hover:bg-white dark:bg-slate-800/20 hover:text-white"
              >
                <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {dados.secoes.map((secao, i) => (
                <div key={i}>
                  <div className="mb-2 flex items-center gap-2">
                    ...
                    <h3 className="text-sm font-bold text-gray-900 dark:text-slate-100">{secao.titulo}</h3>
                  </div>
          ...
          {/* Footer */}
          <div className="border-t border-gray-100 dark:border-slate-700/50 bg-gray-50 dark:bg-slate-900 px-6 py-4">
            <button
              type="button"
              onClick={fechar}
